...
public class UserCoreServiceImpl implements IUserCoreService {
    ...
    @Override
    public ResponseDTO<UserLoginResponse> login(UserLoginRequest request) {
        ...
        try {
            ...
            if (user == null || !user.getPassword().equals(request.getPassword())) {
                return ResponseDTO.newSuccessInstance(ResponseCodeEnum.USERORPASSWORD_ERRROR.getCode(),
                        ResponseCodeEnum.USERORPASSWORD_ERRROR.getMsg(), response);
            }
            ...
            return ResponseDTO.newSuccessInstance(ResponseCodeEnum.SUCCESS.getCode(), ResponseCodeEnum.SUCCESS.getMsg(), response);
        } catch (Exception e) {
